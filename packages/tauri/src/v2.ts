import { randomId, OperationType } from "@rspc/client";
import { AlphaTransport, AlphaRSPCError } from "@rspc/client/v2";
import { listen, UnlistenFn } from "@tauri-apps/api/event";
import { appWindow } from "@tauri-apps/api/window";

export class TauriTransport implements AlphaTransport {

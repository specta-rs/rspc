...
use specta::{datatype::DataType, NamedType, SpectaID, Type, TypeCollection};
    ...
    fn default() -> Self {
        Self {
            ...
            types: TypeCollection::default()
                .with_header("// This file was generated by [rspc](https://github.com/specta-rs/rspc). Do not edit this file manually.\n"),
...
impl<TCtx> Router2<TCtx> {
    ...
    pub fn build(
        ...
        (
            impl Into<Procedures<TCtx>> + Clone + fmt::Debug,
            TypeCollection,
        ),
        (),
    > {
